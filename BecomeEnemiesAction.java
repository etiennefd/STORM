 ...
 * @author etienne
 */
public class BecomeEnemiesAction extends Action {
    
    public BecomeEnemiesAction(StoryCharacter pChar, StoryCharacter pOther, Location pLoc) {
        super();
        
        //Text to be displayed when the action is performed in the story
        aNarrativeForm = "The " + pChar + " and the " + pOther + " talked with each"
                + " other and became enemies.";
        ...
        aPostTrue.add(new WorldProperty(pChar, PropertyKey.HATES, pOther));
        aPostTrue.add(new WorldProperty(pOther, PropertyKey.HATES, pChar));
